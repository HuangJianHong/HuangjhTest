...
/**
 * Created by HuangYH on 2016/5/20.
 * greenDao升级辅助类
 * 注意： 新增的字段还是修改原来的字段，一定是要对象类型，不能使用基本类型int -> Integer
 */
...
public class MigrationHelper {
    ...
    private String getTypeByClass(Class<?> type) throws Exception {
        ...
        throw new Exception(CONVERSION_CLASS_NOT_FOUND_EXCEPTION.concat(" - ClassEntity: ").concat(type.toString()));
    }
