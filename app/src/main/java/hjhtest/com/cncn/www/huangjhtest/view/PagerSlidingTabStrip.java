...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.ic_launcher;     // TODO
...
//        tab.setSingleLine();
    ...
    public void updateTabStyles() {          //由private 改为 public，该类的主要
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (i == selectedPosition) {           //用来改变选中的tab的字体的颜色 和 样式；
