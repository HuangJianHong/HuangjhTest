...
public class BaseWebView extends WebView {
    ...
    private String publicParams = "";//构建url参数
    ...
    public void buildPublicParams(String params) {
    ...
    public void loadUrl(String url) {
        ...
        if (!url.contains("authenUserId")) {
            url = url + (url.contains("?") ? ("&" + publicParams) : ("?" + publicParams));
        }
        LogUtil.d("load_url:", url);
        super.loadUrl(url);
    }
