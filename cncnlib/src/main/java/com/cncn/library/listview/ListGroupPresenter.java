...
import com.cncn.library.listview.adapter.IGroupAdapter;
import com.cncn.library.listview.listview.IGroupListView;
import com.cncn.library.listview.loading.IGroupLoadingHelp;
import com.cncn.library.listview.loading.OnFailClickListener;
import com.cncn.library.listview.manager.IGroupManager;
import com.cncn.library.rx.CSubscriber;
    ...
    private void refreshData() {
        ...
        mManager.refreshData(mContext)
                .subscribe(new CSubscriber<List<T>>() {
                    ...
                    @Override
                    public void onError(ErrorThrowable throwable) {
                        Log.e(ListGroupPresenter.class.getSimpleName(), "errorCode:" + throwable.code  + " msg："+ throwable.msg );
